...
df = spark.read.format("csv").option("header","true").load("abfss://b79aed05-325a-458e-8274-26078b75c2ff@onelake.dfs.fabric.microsoft.com/affb2433-fd2f-4def-bee3-4f7e0ef30644/Files/beauty_sales_sample.csv")
