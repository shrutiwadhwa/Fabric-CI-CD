...
raw_data='abfss://c48bbed2-cdef-4f1e-9ff6-04461745e6d4@onelake.dfs.fabric.microsoft.com/c8aba4c8-e9b4-400f-8020-b15f4d0e0266/Files/Bronze'
df = spark.read.format("csv").schema(sales_schema).option("header","false").load(raw_data)
