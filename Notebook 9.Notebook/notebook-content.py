...
df.write.format("delta").save("Tables/dbo/dirty_transaction_data_amit")
...
spark.sql("DROP TABLE IF EXISTS dirty_transaction_data_amit")
...
spark.sql("DROP TABLE IF EXISTS Day1Lakehouse.dirty_transaction_data_amit")
...
df.drop("Tables/dirty_transaction_data_amit")
